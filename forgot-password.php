...
<head>
    ...
    <title>Forgotten Password - CMSYS</title>
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-password-image" style="background-image: url(&quot;assets/img/resetpass.png&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="forgetPassword.php" method="post" autocomplete="off">
